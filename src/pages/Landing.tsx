...
import { Brain, CalendarDays, Lock, Smartphone, TrendingUp, Zap } from "lucide-react";
...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative flex min-h-screen items-center overflow-hidden pt-16">
      ...
      <div className="container relative mx-auto section-padding py-20 lg:py-32">
        <div className="max-w-2xl">
          ...
          <h1
            data-reveal
            className="mb-6 font-display text-4xl font-bold leading-[1.05] tracking-tight opacity-0 sm:text-5xl lg:text-6xl"
          >
            Tu plan fitness personalizado <span className="text-gradient">en segundos</span>
          </h1>

          <p data-reveal className="mb-8 max-w-lg text-lg leading-relaxed text-muted-foreground opacity-0">
            Sin nutricionista. Sin complicaciones. Obten tu dieta y rutina de entrenamiento adaptada a tus objetivos con IA avanzada.
          </p>
...
const features = [
  { icon: Brain, title: "IA personalizada", desc: "Planes generados en segundos segun tu cuerpo y objetivos" },
  { icon: CalendarDays, title: "Rutina semanal", desc: "Entrenamiento dia a dia adaptado a tu disponibilidad" },
      ...
      <div className="container mx-auto section-padding">
        <div className="mb-16 text-center">
          <h2 data-reveal className="mb-4 font-display text-3xl font-bold tracking-tight opacity-0 sm:text-4xl">
            Todo lo que necesitas para <span className="text-gradient">transformarte</span>
          </h2>
          ...
          <div data-reveal className="glass-card glow-primary rounded-2xl p-8 opacity-0">
            ...
            <ul className="mb-8 space-y-3 text-left text-sm">
              {[
                ...
                "Regeneracion ilimitada de planes",
    ...
    <section ref={ref} className="py-24 lg:py-32">
      <div className="container mx-auto section-padding text-center">
        ...
        <p data-reveal className="mx-auto mb-8 max-w-md text-muted-foreground opacity-0">
          Unite a miles de personas que ya estan alcanzando sus metas fitness con IA.
        </p>
